...
class Application extends App implements IBootstrap {
	...
	public function boot(IBootContext $context): void {
		...
		$context->getAppContainer()->injectFn([$this, 'registerHooks']);
		$context->getAppContainer()->injectFn([$this, 'registerContactsManager']);
		$context->getAppContainer()->injectFn([$this, 'registerCalendarManager']);
		$context->getAppContainer()->injectFn([$this, 'registerNotifier']);
		$context->getAppContainer()->injectFn([$this, 'registerCalendarReminders']);
	}
