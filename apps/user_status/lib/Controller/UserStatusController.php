...
class UserStatusController extends AStatusController {
	...
	public function __construct(string $appName,
		...
		parent::__construct($appName, $request, $predefinedStatusService);
		$this->userId = $userId;
		$this->logger = $logger;
	...
	public function getStatus(): DataResponse {
		...
		return new DataResponse($this->formatPrivateStatus($userStatus));
	}
	...
	public function setStatus(string $statusType): DataResponse {
		try {
			...
			return new DataResponse($this->formatPrivateStatus($status));
